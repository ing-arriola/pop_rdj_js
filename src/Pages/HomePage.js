      ...
      <div className="vh-100">
          ...
          <Container className="d-flex justify-content-around pt-5">
                <div className="w-25">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis iste nemo praesentium repellat. Assumenda, harum, veniam? Amet consequatur cumque cupiditate minus molestias quaerat voluptatum? Accusamus aut hic iste tempore temporibus!</p>
                </div>
                <div>
          ...
          <Container className="d-flex justify-content-around pt-5 pb-5">
              ...
              <div className="w-25">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aliquid consequuntur debitis dolore ducimus eaque eius exercitationem ipsam ipsum labore laudantium neque nisi omnis quam quia quidem quo, repudiandae?</p>
              </div>
