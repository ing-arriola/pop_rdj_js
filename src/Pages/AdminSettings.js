                ...
                <Container className="pt-4">
                    ...
                    <div className="options">
                        <div className="d-flex justify-content-between">
                            ...
                            {stateRegister?
                                <select defaultValue={stateRegister} className="custom-select mr-sm-2" style={{width:"160px"}} id="inlineFormCustomSelect" onChange={(e)=>{
                        ...
                        <hr/>
                        <button onClick={saveSettings} className="btn btn-lg btn-block hero-button float-right rdjf" disabled={disableSave} style={{width:"100px"}}>Guardar</button>
                    </div>
                </Container>
            </div>
        </>
