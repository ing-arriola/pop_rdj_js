            ...
            <Container className="mt-5 mb-5 pb-5 pt-5">
                <Row>
                    ...
                    <div className="col-md-7">
                        <img src={imgLop} width={700} className="p-3 img-fluid" alt="Responsive image"/>
                    </div>
                </Row>
            </Container>
                ...
                <Row>
                    <div className="col-sm d-flex flex-column align-items-center justify-content-center">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis iste nemo praesentium
                            repellat. Assumenda, harum, veniam? Amet consequatur cumque cupiditate minus molestias
                            quaerat
                            voluptatum? Accusamus aut hic iste tempore temporibus!</p>
                        <a href="https://rdjfuturo.netlify.app/about/" target="_blank">Leer mas</a>
                    </div>
                    <div className="col-sm">
                        <img src={imtAbout} width={450} className="img-fluid" alt="Responsive image"/>
                    </div>
                </Row>
            </Container>
            <Container className="pt-5 mb-5 pb-5">
                <Row>
                    <div className="col-sm order-md-2 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aliquid consequuntur
                            debitis
                    ...
                    <div className="col-sm order-md-1">
                        <img src={imtOurMission} width={450} className="img-fluid" alt="Responsive image"/>
                    </div>
                </Row>
            </Container>
        </div>
